...
if(isset($_POST["score"])){
    ...
    mysqli_stmt_bind_param($stmt, "ii", $user, $score);//this assigns two string objects, said to be strings by the "ss", with s = string, to the ?'s. the 1st ? is $user and 2nd ? is                                                            //$score
    //executes everything
