...
function startGame() {
  ...
  ajax.onreadystatechange = function(){
      ...
      if(resp.status === 200){
			  speed = parseInt(resp.data.speed);
			  targetLength = parseInt(resp.data.targetLength);
			  sideLength = parseInt(resp.data.sideLength);
        countdown = parseInt(resp.data.countdown);
	    }
    }
  }
